    ...
    <div class="row">
        <div class="col-md-12">           
            ...
            <div class="input-group mb-3" id="pretraga">
              <input type="text" class="form-control me-2" placeholder="Search my food.." aria-label="pretraga" aria-describedby="pretraga" id="myfood-search" name="moja_pretraga">
...
{{ csrf_field() }}
        ...
        </div><!--kraj diva za editiranje namirnice -->
                       <!-- ispis tablice namirnica -->
                       
                       <div id="ispis-mojih-namirnica">                                      
               @if (count($moje_namirnice) > 0)
               <p class="float-start"><b> My food informations</b></p>
               <div class="table-responsive-sm mt-4" >
                <table class="table table-hover bg-light shadow">
                    <thead class="thead t-head">
                        <tr>
...
@endif
        </div> <!--kraj ispisa namirnica -->
        <h4><span class="float-start"><b>Public food database</b></span> </h4>
        <div class="input-group mb-3" id="pretraga">
                ...
                <table class="table table-hover bg-light shadow">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a href="#" type="button" onclick="takeFood({{$namirnica->id}})"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cloud-arrow-down-fill" viewBox="0 0 16 16">
